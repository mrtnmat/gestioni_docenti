...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        query = "CREATE TABLE " + TABELLA_PRESENZE +
                ...
                ");";
        db.execSQL(query);
        query = "CREATE VIEW View_Presenze AS SELECT Tb_Presenze.Ora, Tb_Presenze.Giorno, " +
                "Tb_Classi.Nome AS NomeClasse, Tb_Classi.Sede, " +
                "Tb_Docenti.Nome, Tb_Docenti.Cognome " +
                "FROM Tb_Presenze, Tb_Docenti, Tb_Classi " +
                "WHERE Tb_Presenze.DocenteId = Tb_Docenti._ID " +
                "AND Tb_Presenze.ClasseId = Tb_Classi._ID;";
